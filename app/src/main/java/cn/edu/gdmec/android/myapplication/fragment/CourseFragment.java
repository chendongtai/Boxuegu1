...
import cn.edu.gdmec.android.myapplication.adapter.CourseListItemAdapter;
import cn.edu.gdmec.android.myapplication.R;
import cn.edu.gdmec.android.myapplication.adapter.ADViewPageAdapter;
...
public class CourseFragment extends Fragment  {
    ...
    private ADViewPageAdapter viewPageAdapter;
    ...
    private void initView(View view){
        ...
        viewPageAdapter = new ADViewPageAdapter(getActivity(),viewList);
        vp_advertBanner.setAdapter(viewPageAdapter);
