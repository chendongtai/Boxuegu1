...
import cn.edu.gdmec.android.myapplication.bean.UserBean;
import cn.edu.gdmec.android.myapplication.bean.VideoBean;
import cn.edu.gdmec.android.myapplication.sqlite.SQLiteHelper;
...
public class DBUtils {
    ...
    public void saveVideoPlayList(VideoBean videoBean, String userName){
        //Log.i("--c", "saveVideoPlayList: " + videoBean.toString());
        ...
        long insert = db.insert(SQLiteHelper.U_VIDEO_PLAY_LIST, null, cv);
